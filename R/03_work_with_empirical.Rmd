...
e <- extent(zoop[,1:2])
e <- extent(-180, 180, e[3], e[4]) # change from 179.5 to 180 as better for mapping  
# e <- extent(-180, 180, -78, -40) # change to match modelled data
# e <- e + 1000 # add this as all y's are the same - no need for your data
# # this needs to be 2 lat by 5 long 
columns<-360/5 
rows<-(abs(e[3])-abs(e[4]))/2 
