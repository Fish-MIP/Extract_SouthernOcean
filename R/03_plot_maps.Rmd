...
min = mean_all[[1]]@data@min
plot(mean_all[[1]])

size1_plot<-plot_SO(wmap_df = antmap_df, data_to_plot = mean_all[[1]], proj = circumpolarCRS, legend_name = legend_name, min = 0.5, max = 5)

size1_plot<-size1_plot+ggtitle("A) Total Consumers Biomass 1-10g")

plot(mean_all[[2]])

size2_plot<-plot_SO(wmap_df = antmap_df, data_to_plot = mean_all[[2]], proj = circumpolarCRS, legend_name = legend_name, min =  0.5, max = 5)

size2_plot<-size2_plot+ggtitle("B) Total Consumers Biomass 10-100g")

plot(mean_all[[3]])

size3_plot<-plot_SO(wmap_df = antmap_df, data_to_plot = mean_all[[3]], proj = circumpolarCRS, legend_name = legend_name, min =  0.5, max = 5)

size3_plot<-size3_plot+ggtitle("C) Total Consumers Biomass 100g-1kg")

plot(mean_all[[4]])

size4_plot<-plot_SO(wmap_df = antmap_df, data_to_plot = mean_all[[4]], proj = circumpolarCRS, legend_name = legend_name, min =  0.5, max = 5)

size4_plot<-size4_plot+ggtitle("D) Total Consumers Biomass 1-10kg")

plot(mean_all[[5]])

size5_plot<-plot_SO(wmap_df = antmap_df, data_to_plot = mean_all[[5]], proj = circumpolarCRS, legend_name = legend_name, min =  0.5, max = 5)

size5_plot<-size5_plot+ggtitle("E) Total Consumers Biomass 10-100kg")

size6_plot<-plot_SO(wmap_df = antmap_df, data_to_plot = mean_all[[6]], proj = circumpolarCRS, legend_name = legend_name, min =  0.5, max = 5)
...
jpeg("/home/ubuntu/Extract_SouthernOcean/Output/Fig1.jpg", width = 5, height = 5, units = "in", res = 300, bg = "transparent")
phyto_plot+zoo_plot
dev.off()
...
jpeg("/home/ubuntu/Extract_SouthernOcean/Output/Fig2.jpg", width = 10, height = 10, units = "in", res = 300, bg = "transparent")
p_final
dev.off()
