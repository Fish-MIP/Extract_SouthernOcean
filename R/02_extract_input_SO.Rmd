...
history_year1 = 1998 # 1998 # 1990 # December to March 1998-2020 for phyto and unknown for meso. So do 1998-2014 (last year of historical) 
history_year2 = 2014 # 2014 #1999
future_year1 = NA
future_year2 = NA
season = "summer" #"summer" # added argument, if consider the whole year set this to NA
...
save(mean_phyto, mean_zoo, file = paste("/home/ubuntu/Extract_SouthernOcean/Tmp_data/",  Sys.Date(), "_02_extract_input_SO_means_", removeNA, "_", season, "_zooType_", zoopl, ".RData", sep = ""))
